...
function confirmSubmit(){
   ...
   var id=$('#id').val();
	...
	$.ajax({
		url:'${ctx}/core/ajax/editorResourceInfo.do',
		data:{
			text:text,
			url:url,
			leaf:isLeaf,
...
<body class="content">
  ...
  <input type="hidden" id="id" class="form-control" value="${resource.id}"/>
  <div class="form-group" style="margin-left: 30px;">
      <label for="firstname" class="col-xs-2 control-label">资源名称:</label>
      <div class="col-xs-8">
         <input type="text" id="name" class="form-control" value="${resource.text}"/>
      </div>
  </div>
     <div class="form-group" style="margin-left: 30px;">
	     ...
	     <div class="col-xs-8">
	        <input type="text" id="url" class="form-control" value="${resource.url}"/>
	     </div>
     </div>
   <div class="form-group" style="margin-left: 30px;">
      ...
      <div class="col-xs-8">
         <div class="checkbox">
            <label>
               <input type="checkbox" id="leaf" name="leaf" <c:if test='${resource.leaf}'>checked</c:if>>
            </label>
         </div>
      </div>
   </div>
